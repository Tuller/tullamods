...
BagnonMenu = CreateFrame('Frame', 'BagnonMenu', UIParent)
...
function Menu:Load()
	...
	self.text:SetText(L.FrameSettings)
...
function Menu:AddLayoutPanel()
	local layout = self:AddPanel(L.Layout)
	...
	color:SetPoint('TOPLEFT', top, 'BOTTOMLEFT', 4, 0)
...
do
	...
	function Menu:AddDisplayPanel()
		local panel = self:AddPanel('Display')
