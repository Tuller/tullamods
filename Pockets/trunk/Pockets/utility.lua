...
function PocketUtil:GetBagSize(bag, player)
...
function PocketUtil:GetBagLink(bag, player)
	if self:IsCachedBag(bag, player) then
...
function PocketUtil:GetItemLink(bag, slot, player)
	if self:IsCachedBag(bag, player) then
...
function PocketUtil:GetItemCount(bag, slot, player)
	if self:IsCachedBag(bag, player) then
		if BagnonDB then
...
function PocketUtil:IsAmmoBag(bag, player)
...
function PocketUtil:IsShardBag(bag, player)
...
function PocketUtil:IsProfessionBag(bag, player)
...
function PocketUtil:CreateWidgetClass(type)
