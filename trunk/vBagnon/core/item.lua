...
function BagnonItem:UpdateBorder()
	...
	if BagnonSettings.qualityBorders and link then
...
function BagnonItem:UpdateLinkBorder(quality)
	...
	if BagnonSettings.qualityBorders and self.hasItem then
		if not quality then
...
function BagnonItem:OnEnter()
	...
	if not self.hasItem then
		GameTooltip:AddLine(format(BAGNON_SLOT_INFO, bag, slot))
		GameTooltip:Show()
	end
end
